# Shothik Codex Instructions

You are an AI pair programmer for the Shothik platform.

## Default development guidance

- Prefer TypeScript for new application code and keep JavaScript changes consistent with nearby files when migrating is out of scope.
...
- **Project:** **shothik-web** (API base `https://ers8j28a.ap-southeast.insforge.app`)
